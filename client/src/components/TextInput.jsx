...
export default function TextInput({label, name, type= "text", value, onChange, placeHolder, onBlur}) {
    return (
        <div className="mb-5 grid grid-cols-[100px_1fr] sm:grid-cols-[150px_1fr] sm:gap-3">
            ...
            <input type={type}
                   ...
                   onBlur={onBlur}
                   className="sm:w-64 rounded-md border border-fuchsia-50 pl-2 text-lg text-gray-300 outline-none bg-transparent"/>
        </div>
    );
}

export function TextBoxInput({label, name, cols, rows, value, onChange, placeHolder, onBlur}) {
    return (
        <div className="mb-5 grid grid-cols-[100px_1fr] sm:grid-cols-[150px_1fr] sm:gap-3">
